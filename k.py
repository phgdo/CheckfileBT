...
driver = webdriver.Chrome(executable_path="C:/Users/phg/Desktop/kiemtravideo/chromedriver.exe")

driver.set_window_size(1000, 1000)

driver.get('https://cst.hnue.edu.vn/mod/assign/view.php?id=109940&action=grading')
driver.find_element_by_id('username').send_keys('705105089')
driver.find_element_by_id('password').send_keys('toilaphuong2002')
